  ...
  return (
    <div className="view">
      <div className="view-header">
        <div>
          <h2>📋 Reportes</h2>
          <p className="view-subtitle">Historial de ventas</p>
        </div>
      ...
      <div className="kpi-grid" style={{ marginBottom: 20 }}>
        <div className="kpi-card" style={{ borderTopColor: '#27ae60' }}>
          <div className="kpi-info">
            ...
            <span className="kpi-value">{formatMoney(totalSales)}</span>
          </div>
        </div>
      ...
      <div className="table-container">
        <table className="data-table">
          ...
          <tbody>
            {loading ? (
              <tr><td colSpan="6" className="empty-table">Cargando...</td></tr>
            ) : orders.length === 0 ? (
              <tr><td colSpan="6" className="empty-table">No hay órdenes</td></tr>
            ) : (
